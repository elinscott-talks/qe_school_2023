...
\setbeamertemplate{title page}
{
  ...
  \large
  \textbf{workflows, automation, and more...}
  \end{center}
  \end{minipage}
  \end{tcolorbox}
...
% Outline
% - briefly overview the core ingredients of Koopmans functionals
% - what computational problems do we need to solve (amass a list?)
% - what tools do we have -- perhaps have a table with what functionality each code has?
% - ASE
% - the Workflow class and how it is constructed
% - scriptability
...
\begin{frame}{The workflows}
   ...
   \onslide<4->{(c) via machine learning}
   % \onslide<6>{
...
\begin{frame}{Generic structure}
   ...
   \onslide<7>{We will see examples in the hands-on!}
...
\begin{frame}{Take home messages}
   ...
   % \hfill
   \begin{center}
   \adjustbox{height=0.3\paperheight}{\input{supercell_workflow.tex}\end{tikzpicture}}
   \end{center}
